...
type SharedInformerFactory interface {
	...
	Awesome() awesomecontrollerio.Interface
}

func (f *sharedInformerFactory) Awesome() awesomecontrollerio.Interface {
	return awesomecontrollerio.New(f, f.namespace, f.tweakListOptions)
}
